 ...
 * inputs to the ServerStart class from the ClientStart class.
 * it sets a atomic boolean value to safely close all 
...
//    String clientAddress = socket.getInetAddress().getHostAddress();
    ...
    try (BufferedReader br = new BufferedReader(new InputStreamReader(socket.getInputStream()));
      ...
      while (true) {
        ...
        if (data == null) {
          ClientConnectionHandler.removeSocket(socket);
          socket.close();
